...
userRouter.post("/", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
    var repository, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                repository = typeorm_1.getRepository(User_1.User);
                return [4 /*yield*/, repository.save(request.body)];
            case 1:
                data = _a.sent();
                return [2 /*return*/, response.status(201).json(data)];
            case 2:
                error_1 = _a.sent();
                console.log("err.message: >> ", error_1);
                return [3 /*break*/, 3];
...
userRouter.get("/", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_2 = _a.sent();
                console.log("err.message: >> ", error_2);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
